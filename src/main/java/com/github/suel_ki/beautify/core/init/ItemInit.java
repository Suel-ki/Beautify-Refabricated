...
public final class ItemInit {
	...
	public static final BlockItem LAMP_CANDLEABRA_RED_ITEM = register("lamp_candleabra_red",
			new BlockItem(BlockInit.LAMP_CANDLEABRA_RED, new FabricItemSettings().tab(Beautify.BEAUTIFY_TAB)));
	...
	private static <T extends Item> T register(String name, T item) {
		...
		return Registry.register(Registry.ITEM, Beautify.id(name), item);
	}
